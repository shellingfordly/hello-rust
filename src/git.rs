...
pub fn git_clone(repo_url: &str, local_path: &str) -> bool {
...
pub fn git_pull(repo_url: &str, local_path: &str) {
...
pub fn git_commit(local_path: &str) {
    // 打开本地仓库
...
pub fn git_push(local_path: &str) {
    let repo: Repository = Repository::open(local_path).expect("Failed to open repository");
